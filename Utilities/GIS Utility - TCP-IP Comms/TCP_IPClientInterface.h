...
public:
	...
	/*
	  ...
	  \return Whether the initialisation was successful or not.
	 */
	virtual bool initialise(bool p_bLogToFileEnabled, const WCHAR *p_pcLogFile, bool p_bLogToInterfaceEnabled, bool p_bExtendedNetworkLogging=false) = 0;
	/*
	 ...
	 */
	virtual bool connectToServer(const WCHAR *p_pcIPAddress, int p_iPort, int p_iConnectionTimeout=0, bool p_bWaitUntilConnectionComplete=true, bool p_bContinuouslyMonitorServer=true, bool p_bAutomaticallyReconnectToServer=false) = 0;
	/*
	...
	/*
	  ...
	  \return Whether the connection was successful or not.
	 */
	virtual bool launchAndConnectToServerThroughMonitor(const WCHAR *p_pcIPAddress, int p_iMonitorPort, int p_iServerPort, const WCHAR *p_pcServerID, const WCHAR *p_pcConfigurationPath, bool p_bStartMinimised, bool p_bConnectedToPMB, int p_iConnectionTimeout=0, bool p_bWaitUntilConnectionComplete=true, bool p_bContinuouslyMonitorServer=true, bool p_bAutomaticallyReconnectToServer=false) = 0;
	/*
	  ...
	  \return Whether the connection was successful or not.
	 */
	virtual bool reconnectToServer(const WCHAR *p_pcIPAddress, int p_iPort, int p_iConnectionTimeout=0, bool p_bWaitUntilConnectionComplete=true, bool p_bContinuouslyMonitorServer=true, bool p_bAutomaticallyReconnectToServer=false) = 0;
	/*
	 ...
	 */
	virtual bool sendMessage(const WCHAR *p_pcMessage, WCHAR *p_pcReturn=NULL, int p_iReturnLength=0, bool p_bWaitForComplete=true, bool p_bFailOnCommandError=true) = 0;
	/*
	  This sends a message to the server the client is connected to.
	  This is only valid when connected to a server.
	  \param p_pcMessage - The message to send.
	  ...
	  \return Whether the send was successful or not.
	 */
	virtual bool sendMessage(const WCHAR *p_pcMessage, bool p_bWaitForComplete, int *p_piMessageID, bool *p_pbCommandSuccess, WCHAR *p_pcReturn=NULL, int p_iReturnLength=0, int p_iResponseTimeout=-1) = 0;
	/*
	...
	/*
	  ...
	  \return Whether the send was successful or not.
	 */
	virtual bool sendMessageInNewClient(const WCHAR *p_pcMessage, WCHAR *p_pcReturn=NULL, int p_iReturnLength=0, bool p_bFailOnCommandError=true) = 0;
	/*
	 ...
	 */
	virtual bool readFromServer(WCHAR *p_pcResponse, int p_iResponseLength, int p_iReadTimeout=-1) = 0;
	/*
	  This reads a response from the server the client is connected to.
	  This is only valid when connected to a server.
	 ...
	 */
	virtual bool waitForAcknowledge(const WCHAR *p_pcMessage, int *p_piMessageID, int p_iResponseTimeout=-1) = 0;
	/*
	  ...
	  \return Whether the wait was successful or not.
	 */
	virtual bool waitForInformation(int p_iMessageID, WCHAR *p_pcInformationCode, int p_iInformationCodeLength, WCHAR *p_pcInformationData, int p_iInformationDataLength, int p_iResponseTimeout=-1) = 0;
	/*
	  ...
	  \return Whether the wait was successful or not.
	 */
	virtual bool waitForComplete(int p_iMessageID, WCHAR *p_pcReturn, int p_iReturnLength, bool *p_pbCommandSuccess, int p_iResponseTimeout=-1) = 0;
	...
	/*
	  ...
	  \param p_pppcResponses - This parameter will be populated with the individual values taken from the combined responses. The value returned is an array of responses. The array will be of length p_iNumberOfResponses, and each response will be a WCHAR * of length STANDARD_STRING_SIZE.
	 ...
	 */
	virtual bool splitResponses(const WCHAR *p_pcCombinedResponses, WCHAR ***p_pppcResponses, int &p_iNumberOfResponses) const = 0;
	...
	/*
	  ...
	  \param p_pppcPrintheadNames - This parameter will be populated with the names of the printheads. The value returned is an array of names. The array will be of length p_iNumberOfPrintheads, and each name will be a WCHAR * of length STANDARD_STRING_SIZE.
	 ...
	 */
	virtual bool parsePrintheadInformation(const WCHAR *p_pcPrintheadStatusInformation, WCHAR ***p_pppcPrintheadNames, IPrintheadInformationInterface ***p_pppxPrintheadInformation, int &p_iNumberOfPrintheads) const = 0;
	 ...
	 */
	virtual bool updateLogSettings(bool p_bLogToFileEnabled, const WCHAR *p_pcLogFile, bool p_bLogToInterfaceEnabled, bool p_bExtendedNetworkLogging=false) = 0;
	/*
	  This logs a message.
	...
	*/
	virtual bool log(int p_iLogLevel, const WCHAR *p_pcLogMessage) const = 0;
	/*
	...
	*/
	virtual bool initialisePrintServer(const WCHAR *p_pcConfigurationFile) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool saveConfigurationAs(const WCHAR *p_pcConfigurationFolder) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool applySystemMode(const WCHAR *p_pcSystemModeName) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getSystemModeNames(WCHAR *p_pcSystemModeNames, int p_iSystemModeNamesLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getSystemModeInformation(const WCHAR *p_pcSystemModeName, WCHAR *p_pcRenderModeName, int p_iRenderModeNameLength, WCHAR *p_pcPrintModeName, int p_iPrintModeNameLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintServerParameterValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintServerParameterValues(int p_iNumberOfParametersToChange, const WCHAR **p_ppcParameterNames, const WCHAR **p_pcParameterValue) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintServerParameterValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \param p_pcNodeInformation - The information for the node.
	  \param p_iNodeInformationLength - The length of the p_pcNodeInformation buffer.
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintServerNodeInformation(const WCHAR *p_pcNodePath, const WCHAR *p_pcExcludedNodeTypes, WCHAR *p_pcNodeInformation, int p_iNodeInformationLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setParameterStoreValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getParameterStoreValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool deleteParameterStoreValue(const WCHAR *p_pcParameterName) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool initialiseOperationPrintServer(const WCHAR *p_pcConfigurationFolder) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool shutdownOperationPrintServer(const WCHAR *p_pcPCOperationCode) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getSystemInformation(WCHAR *p_pcSystemInformation, int p_iSystemInformationLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool initialiseRenderEngine(const WCHAR *p_pcConfigurationFile) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool applyRenderMode(const WCHAR *p_pcRenderMode) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getRenderModeNames(WCHAR *p_pcRenderModeNames, int p_iRenderModeNamesLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setRenderEngineParameterValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setRenderEngineParameterValues(int p_iNumberOfParametersToChange, const WCHAR **p_ppcParameterNames, const WCHAR **p_pcParameterValues) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getRenderEngineParameterValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getRenderEngineNodeInformation(const WCHAR *p_pcNodePath, const WCHAR *p_pcExcludedNodeTypes, WCHAR *p_pcNodeInformation, int p_iNodeInformationLength) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool loadDocument(const WCHAR *p_pcDocumentPath) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool startRender(const WCHAR *p_pcRenderOutputPath) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool renderBitmap(const WCHAR *p_pcInputFilePath, const WCHAR *p_pcBitmapOutputPath, double p_dOutputWidth=-1.0, double p_dOutputHeight=-1.0) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool changeImageFile(const WCHAR *p_pcImageFilePath) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool copyRIPFiles(const WCHAR *p_pcRIPFilesPath, const WCHAR *p_pcOutputFolder, int p_iStartColourPlane=0, int p_iEndColourPlane=-1, bool p_bDeleteOriginalFiles=false) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPreview(int p_iPreviewWidth, int p_iPreviewHeight, WCHAR *p_pcPreviewData, int p_iPreviewDataLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPreviewDataPixelValue(const WCHAR *p_pcPreviewData, int p_iPreviewDataLength, int p_iPixelIndex, int &p_iPixelValue) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool initialisePrintController(const WCHAR *p_pcConfigurationFile) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool applyPrintMode(const WCHAR *p_pcPrintMode) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintModeNames(WCHAR *p_pcPrintModeNames, int p_iPrintModeNamesLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintControllerParameterValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintControllerParameterValues(int p_iNumberOfParametersToChange, const WCHAR **p_ppcParameterNames, const WCHAR **p_pcParameterValues) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintControllerParameterValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintControllerNodeInformation(const WCHAR *p_pcNodePath, const WCHAR *p_pcExcludedNodeTypes, WCHAR *p_pcNodeInformation, int p_iNodeInformationLength) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool print(int p_iNumberOfPrints, const WCHAR *p_pcRIPFileItemPath, int p_iNumberOfCopies) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool print(int p_iNumberOfPrints, int p_iNumberOfItems, WCHAR **p_ppcRIPFileItemPaths, int *p_piNumberOfCopies) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool initialisePrint(int p_iNumberOfPrints, const WCHAR *p_pcRIPFileItemPath, int p_iNumberOfCopies) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool initialisePrint(int p_iNumberOfPrints, int p_iNumberOfItems, WCHAR **p_ppcRIPFileItemPaths, int *p_piNumberOfCopies) = 0;
	/*
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool addPrintQueueItem(const WCHAR *p_pcRIPFileItemPath, int p_iNumberOfCopies) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	 */
	virtual bool addPrintQueueItem(int p_iNumberOfItems, WCHAR **p_ppcRIPFileItemPaths, int *p_piNumberOfCopies) = 0;
	/*
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool deletePrintDataDirectories(const WCHAR *p_pcDirectories) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool deletePrintDataFiles(const WCHAR *p_pcFilePaths) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool upgradePMBFirmware(void) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool verifyPMBFirmware(void) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintControllerNodeErrorState(const WCHAR *p_pcNodeNames, WCHAR *p_pcErrorCodes, int p_iErrorCodesLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool initialiseNetworkController(const WCHAR *p_pcConfigurationFile) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setNetworkControllerParameterValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setNetworkControllerParameterValues(int p_iNumberOfParametersToChange, const WCHAR **p_ppcParameterNames, const WCHAR **p_pcParameterValues) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getNetworkControllerParameterValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getNetworkControllerNodeInformation(const WCHAR *p_pcNodePath, const WCHAR *p_pcExcludedNodeTypes, WCHAR *p_pcNodeInformation, int p_iNodeInformationLength) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool broadcastMessageToSlaveServer(const WCHAR *p_pcSlaveServerName, const WCHAR *p_pcMessageToBroadcast, wchar_t *p_pcReturn=NULL, int p_iReturnLength=0) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool broadcastMessageToAllSlaveServers(const WCHAR *p_pcMessageToBroadcast, WCHAR *p_pcReturn=NULL, int p_iReturnLength=0) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool setAsSlaveServer(const WCHAR *p_pcSlaveServerName, const WCHAR *p_pcMasterAddress, int p_iMasterPort) = 0;
	/*
	...
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slaveInitialised(const WCHAR *p_pcSlaveServerName, bool p_bInitialisationSuccess) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slavePrintStarted(const WCHAR *p_pcSlaveServerName) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slaveReadyToPrint(const WCHAR *p_pcSlaveServerName, int p_iNumberOfSwathesToPrint) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slaveSwatheProcessed(const WCHAR *p_pcSlaveServerName, int p_iSwatheProcessed) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slaveSwatheNumber(const WCHAR *p_pcSlaveServerName, int p_iSwatheNumber) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slavePrintFinished(const WCHAR *p_pcSlaveServerName, bool p_bPrintSuccess) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
     */
	virtual bool slaveLog(const WCHAR *p_pcSlaveServerName, int p_iLevel, const WCHAR *p_pcMessage) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool initialisePrintServerMonitor(const WCHAR *p_pcConfigurationFile) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintServerMonitorParameterValue(const WCHAR *p_pcParameterName, const WCHAR *p_pcParameterValue) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool setPrintServerMonitorParameterValues(int p_iNumberOfParametersToChange, const WCHAR **p_ppcParameterNames, const WCHAR **p_pcParameterValues) = 0;
	/*
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintServerMonitorParameterValue(const WCHAR *p_pcParameterName, WCHAR *p_pcParameterValue, int p_iParameterValueLength) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool getPrintServerMonitorNodeInformation(const WCHAR *p_pcNodePath, const WCHAR *p_pcExcludedNodeTypes, WCHAR *p_pcNodeInformation, int p_iNodeInformationLength) = 0;
	...
	*/
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool shutdownOperationPrintServerMonitor(const WCHAR *p_pcPCOperationCode) = 0;
	...
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool launchPrintServerMonitorPrintServer(const WCHAR *p_pcPrintServerName, const WCHAR *p_pcConfigurationPath, int p_iPort, bool p_bStartMinimised, bool p_bConnectedToPMB) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool launchPrintServerMonitorPrintServers(int p_iNumberOfPrintServersToLaunch, const WCHAR **p_ppcPrintServerNames, const WCHAR **p_ppcConfigurationPaths, int *p_piPorts, bool *p_pbStartMinimised, bool *p_pbConnectedToPMB) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool startPrintServerMonitorPrintServer(const WCHAR *p_pcPrintServerName) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool shutdownPrintServerMonitorPrintServer(const WCHAR *p_pcPrintServerName) = 0;
	/*
	  ...
	  \return Whether the command executed successfully.
	*/
	virtual bool restartPrintServerMonitorPrintServer(const WCHAR *p_pcPrintServerName) = 0;
};
